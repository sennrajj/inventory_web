    ...
    <div class="container mt-4">
        <figure>
            <blockquote class="blockquote">
                <h2 class="fw-semibold">BARANG KELUAR</h2>
        ...
        <!-- Button Tambah Data -->
        <a href="keluar.php" type="button" class="btn btn-primary fw-semibold">
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $row['stock_keluar'] . "</td>";
                                    echo "<td>
                                            <a href='edit.php?id=" . $row['id'] . "&type=keluar&redirect=barang_keluar.php' class='btn btn-warning btn-sm fw-semibold'>
                                                <i class='bx bxs-edit-alt'></i>
                                                Edit
                                            </a>
                                            <a href='delete.php?id=" . $row['id'] . "&type=keluar&redirect=barang_keluar.php' class='btn btn-danger btn-sm fw-semibold' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'>
