...
<body style="padding-bottom: 80px;">
	...
	<div class="container mt-5">
		...
		<div class="mb-3 row">
		    ...
		    <div class="col-sm-10">
		      <input type="number" class="form-control" id="stock_masuk" name="stock_masuk" placeholder="Stock Masuk" required>
		    </div>
		</div>
		...
		<div class="mb-3 row mt-5">
			<div class="col">
				...
				<a href="barang_masuk.php" class="btn btn-danger fw-semibold">
